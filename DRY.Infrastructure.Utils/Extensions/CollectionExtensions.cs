using DRY.Infrastructure.Utils.DataModelBase;
using System;
...
namespace DRY.Infrastructure.Utils.Extensions
{
    /// <summary>
    /// 集合扩展方法类
    /// </summary>
    public static class CollectionsExtensions
    {
        ...
        /// <summary>
        /// 将集合展开，并分别转换成字符串，再以指定的分隔符衔接，拼成一个字符串返回
        /// </summary>
        ...
        public static IQueryable<TEntity> Where<TEntity, TKey>(this IQueryable<TEntity> source,
            Expression<Func<TEntity, bool>> predicate, int pageIndex, int pageSize, out int total, PropertySortCondition[] sortConditions = null) 
